...
![image-20210528173902982](img/image-20210528173902982.png)
...
![image-20210528173925500](img/image-20210528173925500.png)
...
![image-20210528173944087](img/image-20210528173944087.png)
...
![image-20210528174005867](img/image-20210528174005867.png)

### MyISAM 和 InnoDB 的区别

![image-20210528174017995](img/image-20210528174017995.png)
...
![image-20210528174049674](img/image-20210528174049674.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![image-20210528174100652](img/image-20210528174100652.png)
