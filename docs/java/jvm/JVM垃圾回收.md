...
![](img/01d330d8-2710-4fad-a91c-7bbbfaaefc0e.png)
...
![image-20210529114217058](img/image-20210529114217058.png)
...
> 修正：“Hotspot 遍历所有对象时，按照年龄从小到大对其所占用的大小进行累积，当累积的某个年龄大小超过了 survivor 区的 50% 时（默认值是 50%，可以通过 `-XX:TargetSurvivorRatio=percent` 来设置），取这个年龄和 MaxTenuringThreshold 中更小的一个值，作为新的晋升年龄阈值”。
>
> jdk8官方文档引用 ：https://docs.oracle.com/javase/8/docs/technotes/tools/unix/java.html 。
>
> ![](img/image-20210523201742303.png)
>
> **动态年龄计算的代码如下：**
>
> ```c++
...
> ```
>
> 额外补充说明：**关于默认的晋升年龄是 15，这个说法的来源大部分都是《深入理解 Java 虚拟机》这本书。**
...
![](img/b48228c2-ac00-4668-a78f-6f221f8563b5.png)
...
![image-20210529114420155](img/image-20210529114420155.png)
...
![image-20210529114508575](img/image-20210529114508575.png)
