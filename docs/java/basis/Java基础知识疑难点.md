...
![《阿里巴巴Java开发手册》对这部分BigDecimal的描述](img/BigDecimal.png)
...
![阿里巴巴Java开发手-Arrays.asList()方法](img/阿里巴巴Java开发手-Arrays.asList()方法.png)
...
![不要在 foreach 循环里进行元素的 remove/add 操作](img/Snipaste_2021-05-29_10-49-01.png)
