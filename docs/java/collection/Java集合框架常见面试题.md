...
![双向链表](img/Snipaste_2021-05-29_11-19-32.png)

**双向循环链表：** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![image-20210529112047693](img/image-20210529112047693.png)
...
![jdk1.8之前的内部结构-HashMap](img/jdk1.8之前的内部结构-HashMap.png)

#### 1.4.5.2. JDK1.8 之后

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![jdk1.8之后的内部结构-HashMap](img/jdk1.8之后的内部结构-HashMap.png)
...
![image-20210529112306388](img/image-20210529112306388.png)



**JDK1.7 的 ConcurrentHashMap：**

![image-20210529112439717](img/image-20210529112439717.png)



**JDK1.8 的 ConcurrentHashMap：**

![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](img/java8_concurrenthashmap-1622258694188.png)
