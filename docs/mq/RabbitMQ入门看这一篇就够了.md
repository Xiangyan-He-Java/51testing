...
![Exchange(交换器) 示意图](img/24007899.jpg)
...
![RabbitMQ 和 Erlang 的版本关系](img/RabbitMQ-Erlang.png)
...
```
![输出“hello world”](img/49570541.jpg)
...
![输入 erl 查看 erlang 环境变量是否配置正确](img/62504246.jpg)
